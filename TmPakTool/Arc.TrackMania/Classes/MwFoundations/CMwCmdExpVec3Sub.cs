...
{
    public class CMwCmdExpVec3Sub : CMwCmdExpVec3
    {
        public override uint ID
        {
            get { return 0x0108A000; }
        }
        ...
        {
            get { return ((Chunk000)GetChunk(0x0108A000)).Vec1; }
            set { ((Chunk000)GetChunk(0x0108A000)).Vec1 = value; }
        }

        public CMwCmdExpVec3 Vec2
        {
            get { return ((Chunk000)GetChunk(0x0108A000)).Vec2; }
            set { ((Chunk000)GetChunk(0x0108A000)).Vec2 = value; }
        }
