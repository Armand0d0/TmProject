...
{
    public class CMwCmdExpVec3Function : CMwCmdExpVec3
    {
        public override uint ID
        {
            get { return 0x0109F000; }
        }
        ...
        {
            get { return ((Chunk000)GetChunk(0x0109F000)).FuncInterface; }
            set { ((Chunk000)GetChunk(0x0109F000)).FuncInterface = value; }
        }
