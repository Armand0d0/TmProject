...
{
    public class CMwCmdExpBoolIdent : CMwCmdExpBool
    {
        public override uint ID
        {
            get { return 0x0103C000; }
        }
        ...
        {
            get { return ((Chunk000)GetChunk(0x0103C000)).IdentInterface; }
            set { ((Chunk000)GetChunk(0x0103C000)).IdentInterface = value; }
        }
